...
for _, name in ipairs({"SpideyHub", "AceDuelsAdaptReconstruct", "AdaptHubPolished", "CyberHub"}) do
...
-- Spider-Verse palette. Every original key is kept with the same meaning so
-- existing call sites keep working; the accent/web entries carry the theme.
local COLORS = {
...
a1.BackgroundTransparency = 1; a1.Text = "S\n🕷"; a1.TextColor3 = COLORS.accent
...
suit.BackgroundTransparency = 1; suit.Text = "🕷"; suit.TextColor3 = COLORS.accent
...
a2.BackgroundTransparency = 1; a2.Text = "S\n🕷"; a2.TextColor3 = COLORS.accent
...
titleShadow.Text = "SPIDEY HUB"; titleShadow.TextColor3 = Color3.fromRGB(0,0,0); titleShadow.Font = Enum.Font.GothamBlack; titleShadow.TextSize = 72
...
title.Text = "SPIDEY HUB"; title.TextColor3 = COLORS.accent; title.Font = Enum.Font.GothamBlack; title.TextSize = 72
