...
-- the skull: a plain image, nothing drawn behind it
RainySkull = Instance.new("ImageLabel")
RainySkull.Name = "Skull"
RainySkull.BackgroundTransparency = 1
RainySkull.BorderSizePixel = 0
